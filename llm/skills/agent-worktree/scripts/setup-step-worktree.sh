...
#
# Usage:
#   setup-step-worktree.sh <REPO_ROOT> <ORCH_WORKTREE> <ORCH_BRANCH> <PLAN_HANDLE> <STEP_ID>
#
# Arguments:
...
#
# Creates:
#   - Branch: orch-<PLAN_HANDLE>-step-<STEP_ID>
...
if [[ $# -ne 5 ]]; then
  echo "Usage: setup-step-worktree.sh <REPO_ROOT> <ORCH_WORKTREE> <ORCH_BRANCH> <PLAN_HANDLE> <STEP_ID>" >&2
  exit 1
fi
